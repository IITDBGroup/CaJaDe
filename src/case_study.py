...
mimic_question_dict_5['uquery'] = (mimic_uq5, 'mimic5')
...
nba_question_dict_1['uquery'] = (nba_uq1, 'nba1')
...
nba_question_dict_2['uquery'] = (nba_uq2, 'nba2')
...
nba_question_dict_3['uquery'] = (nba_uq3, 'nba3')
...
nba_question_dict_4['uquery'] = (nba_uq4,'nba4')
...
nba_question_dict_5['uquery'] = (nba_uq5, 'nba5')
