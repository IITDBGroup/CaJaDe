...
# originals: 3 differnt max number of egdes
python3 experiments.py -M 1 -p jape -U japerev -P 5433 -d nba_rev -t o -m 0 -i false  -D march16_sample
python3 experiments.py -M 2 -p jape -U japerev -P 5433 -d nba_rev -t o -m 0 -i false  -D march16_sample
python3 experiments.py -M 3 -p jape -U japerev -P 5433 -d nba_rev -t o -m 0 -i false  -D march16_sample
...
for s in ${samplerates[@]}
	do 
		...
		do
		    ...
		    python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_rev -t s -m 0 -i false -F ${s} -D march16_sample
	    done
	done
