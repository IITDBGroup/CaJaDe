...
# # originals: 3 differnt max number of egdes
# python3 experiments.py -M 1 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_sample
# python3 experiments.py -M 2 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_sample
# python3 experiments.py -M 3 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_sample
...
# 			# echo "python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_rev -t s -m 0 -i false -F ${s} -D feb11_nba_15_vs_12_sample_rate_eval"
# 		    # python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_rev -t s -m 0 -i false -F ${s} -D feb17_nba_sample
# 		    # python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_rev -t s -m 0 -i false -F ${s} -D march11_2
# 		    python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_original -t s -m 0 -i false -F ${s} -D april_4_sample
# 	    done
# 	done
...
for i in ${iters[@]}
	do
		python3 experiments.py -M 1 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_repeat_${i}
		python3 experiments.py -M 2 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_repeat_${i}
		python3 experiments.py -M 3 -p jape -U japerev -P 5433 -d nba_original -t o -m 0 -i false  -D april_4_repeat_${i}

		for s in ${samplerates[@]}
			do 
				for e in ${maxedges[@]}
				do
				    python3 experiments.py -M ${e} -p jape -U japerev -P 5433 -d nba_original -t s -m 0 -i false -F ${s} -D april_4_repeat_${i}
			    done
			done
	done